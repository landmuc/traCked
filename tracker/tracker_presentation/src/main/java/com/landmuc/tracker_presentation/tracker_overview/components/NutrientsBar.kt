...
import com.landmuc.core_ui.CarbColor
import com.landmuc.core_ui.FatColor
import com.landmuc.core_ui.ProteinColor
...
fun NutrientsBar(
    ...
    // use LaunchedBlock to animate these values as soon as the composable is composed
    // everytime our carbs state changes we want to re-trigger the Launched Block
